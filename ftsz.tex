...
To begin our investigation of the structure of DrFtsZ, we collected a dataset for SPA from \textit{in vitro} purified FtsZ... TODO: how was it prepared exactly? concentrations, wait time for polymerization, ...
...
\begin{figure}[ht]
    ...
    \titledcaption[FtsZ filament: anisotropic map]{FtsZ filament map affected by preferential orientation, viewed from the same direction as most 2D classes (top) and rotated by \ang{90} (bottom) to highlight the streaking artifacts due to anisotropic orientation sampling.}
...
TODO: worked on \fullref{stemia_angles}...
