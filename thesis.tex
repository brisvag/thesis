...
\frontmatter \pagenumbering{Roman}  % versus "roman" which is lowercase numerals
    ...
    \epigraph{The place they go towards is a place even less imaginable to most of us than the city of happiness. I cannot describe it at all. It is possible that it does not exist. But they seem to know where they are going, the ones who walk away from Omelas.}{\textit{The ones who walk away from Omelas} --- \textbf{Ursula K. Le Guin}}  % TODO: dedication or cool quote
...
% TODO: in printed version ensure that authors lines, header titles, etc don't go beyond edge
% TODO: don't forget to keep the resume up to date in french
