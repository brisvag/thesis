...
In the \fullref{introduction} of this manuscript, I lay out the theoretical foundations of cryo-electron microscopy, single particle analysis, and cryo-ET, contextualized within a typical data collection and processing workflow.
