...
This project has now been picked up by other members of the group, and by using existing and new datasets it'is already showing promising improvements over this work, both on the single particle (\fullref{future_ftsz_spa}) and the subtomogram averaging work (\fullref{future_ftsz_sta}).
