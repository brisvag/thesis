...
The cross-correlation of two signals (such as two images) is a measure of how similar the two signals are at all possible relative shifts. For example, in the 1D case of \autoref{fig:cross_correlation}
