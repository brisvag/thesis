...
When this problem arises, there are a few ways to tackle it.
...
Other methods are a bit more involved, such as the use of functionalized graphene grids~\cite{luFunctionalizedGrapheneGrids2022} (CITE ask irina).
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[B]{.48\textwidth}
        ...
        \caption{Different ways electrons can scatter.}
        \label{fig:em_scattering}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[B]{.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{example-image-9x16.png}
        \caption{Electron waves path through a microscope.}
        \label{fig:em_microscope}
    \end{subfigure}%
    \caption[Image formation]{TODO: describe a bit electron scattering and intereference and how this results in image formation.}
...
For example, in the 1D case of (TODO...) \autoref{fig:em_cross_correlation}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{introduction/cross_correlation.png}
    \caption[Cross correlation]{Cross correlation of two 1D signals. TODO}
    \label{fig:em_cross_correlation}
    % TODO: generated with cc_image.py script. Should add somehow to thesis!
    % TODO: why the hell is this background not white...
\end{figure}
