...
In practice, this is often used to remove high-frequency components (low-pass filter), and sometimes with also very low frequency components (band-pass filter) (\autoref{fig:em_filtering}).
