...
\begin{figure}
    ...
    \resizebox{\textwidth}{!}{\begin{tikzpicture}[node distance=2ex and 5ex]
        ...
        \node (coll) [node, below = of vit, yshift=-4ex] {Data collection};
        ...
        \node[draw=Green,dotted,fit=(pick) (class) (sel) (recon),label={[text=Green]Processing}] {};
...
\begin{figure}
    ...
    % generated with cc_image.py script
\end{figure}
