...
This chapter describes the theory of cryo-ET, how it deviates from SPA in its workflow (\autoref{fig:et_workflow}), and the current state of the art with its limitations and upcoming developments.
