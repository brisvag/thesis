...
TODO: end with sentence on how lots of limitations are due to the current state of the software ecosystem
...
\1 what it provides compared to SPA
    \2 more native state and context preservation
    \2 single-particle insights
    \2 mesoscale and superstructural information
\1 limitations (both in terms of technique, and in terms of current state of development)
    \2 (some mentioned before, maybe need to connect these two parts a bit better)
    \2 need for custom workflow cause the goal and problems are usually unique
    \2 issues caused by the missing wedge (alignement, reconstruction, interpretability)
    \2 SNR, denoising
