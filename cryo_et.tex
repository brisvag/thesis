...
All these techniques rely on drawing information about an ensemble of molecules, typically with an \textit{in vitro} purified sample.
...
\begin{figure}
    ...
    \resizebox{\textwidth}{!}{\begin{tikzpicture}[node distance=2ex and 5ex]
        ...
        \node (subtomo) [node, below = of pick] {Subtomgram Averaging};
        ...
        \node[draw=lime,dotted,fit=(annot) (pick) (subtomo),label={[text=lime]Processing}] {};
